...
public abstract class adaptermessage extends RecyclerView.Adapter<viewholdermessage> {
    private Context context;
    private   List<item> items;
    private MediaPlayer mediaPlayer;
    private   int currentlyplayingposition = -1;

    public adaptermessage(Context context, List<item> items) {
    ...
    public viewholdermessage onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new viewholdermessage(LayoutInflater.from(context).inflate(R.layout.layout,parent,false));
    }
